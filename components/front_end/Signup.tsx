...
export function Signup() {
  return (
    <div className={cn("grid w-full h-full max-w-sm items-center gap-[1.25rem] relative")}>
      ...
      <div className={cn("flex flex-col top-[8rem] max-w-sm relative w-full items-center justify-center",kumbh_sans_darker.className)}>
        
        <Button
          variant={"blueg"}
          size={"blueg"}
          className={cn("rounded-xl h-[3rem] shadow-2xl w-full text-[1rem] ")}
          onClick={() => console.log("Clicked")}
        >
          Sign Up
        </Button>

        <div className="pl-4 pt-2 text-violetBlue w-full relative items-center justify-center">
