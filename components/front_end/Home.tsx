  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div className="flex flex-col items-center justify-start w-full px-2 pb-10 md:max-h-80 bg-yellowLight">
        <span
          className={cn(
            "font-semibold text-textGrey text-[1.375rem] pr-2 mt-[1.25rem]",
            jua.className
          )}
        >
          Welcome to
        ...
        <div className="flex flex-col justify-center text-justify">
          <span
            className={cn(
              "font-extrabold text-violetBlue text-4xl pr-[-0.2rem] mt-[-0.3rem]",
              jua.className
            )}
          >
            Where is my bus?
        ...
        <div className="flex flex-col items-center justify-center px-4 pt-4 text-justify">
          <p
            className={cn(
              "max-w-full tracking-[-0.035em] text-justify text-[0.76rem] mt-[0.85rem] leading-snug relative",
              manrope.className
            )}
          >
      ...
      <div
        className={cn("flex flex-col items-center max-w-screen-md h-[24.5rem]")}
      >
        <span
          className={cn(
            "text-violetBlue font-extrabold text-[2.1rem] violetBlue mt-4",
            jua.className
          )}
        >
          Our Features
            ...
            <CarouselItem>
              ...
              >
                <Image
                  ...
                  alt="student"
                  className="w-[185px] h-[185px] mt-[1rem] mr-5 "
                />
              </div>

              <span
                className={cn(
                  "text-violetBlue tracking-tight text-[1.4rem] font-extrabold violetBlue left-16 top-3 relative ",
                  kumbh_sans_darker.className
                )}
              >
              ...
              <div
                className={cn(
                  "w-[86%] left-3 right-3 tracking-[-0.02em] font-medium text-justify text-[0.83rem] mt-[0.85rem] leading-tight relative",
                  kumbh_sans_lighter.className
                )}
              >
                Our solution is uniquely designed for college students,
                providing practical and student-focused functionalities that
                cater to their daily needs and challenges.{" "}
              </div>
            </CarouselItem>
            ...
            <CarouselItem>
              ...
              >
                <Image
                  ...
                  alt="student"
                  className="w-[183px] h-[183px] mt-[0.9rem] "
                />
              </div>

              <span
                className={cn(
                  "text-violetBlue tracking-tight text-[1.4rem] font-extrabold violetBlue left-28 top-3 relative ",
                  kumbh_sans_darker.className
                )}
              >
                Reliable Tracking{" "}
              ...
              <div className="w-[88%] left-3 right-3 tracking-[-0.02em] font-medium text-justify text-[0.83rem] mt-[0.85rem] leading-tight relative">
                Our GPS technology ensures precise location tracking for
                accurate bus location updates. Continuous tracking ensures
                reliable updates even in areas with network issues.{" "}
              </div>
            </CarouselItem>
            ...
            <CarouselItem>
              ...
              >
                <Image
                  ...
                  alt="student"
                  className="w-[183px] h-[183px] mt-[0.8rem] "
                />
              </div>

              <span
                className={cn(
                  "text-violetBlue tracking-tight text-[1.4rem] font-extrabold violetBlue left-24 top-3 relative ",
                  kumbh_sans_darker.className
                )}
              >
                Real time precision{" "}
            ...
            <CarouselItem>
              ...
              >
                <Image
                  src={carousel_item4}
                  alt="student"
                  className="w-[290px] h-[188px] mt-[0.9rem] "
                />
              </div>
      ...
      <div className="flex flex-row justify-between text-white bg-greyfooter ">
        <div className="flex flex-col items-start justify-center w-64 mt-5 ">
          ...
          <div className="flex flex-col items-center justify-center pl-4 text-justify ">
            <p
              className={cn(
                "tracking-[-0.040em] text-justify text-[11px] leading-snug relative",
                manrope.className
              )}
            >
