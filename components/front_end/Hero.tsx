  ...
  return (
    < >
      ...
      <div className="flex flex-col justify-start items-center pt-8 font-extrabold text-5xl bg-grey w-full h-96" >
        ...
        <div className={`group flex flex-col ${jua.className} text-violetBlue`}>
        ...
        <div  className={`${manrope.className} flex flex-col justify-center items-center relative bottom-7 `}>
